...
String crusherStatus = "On";
String screenStatus = "On";

uint8_t crusherStoppedFrame[] = {  //7E 00 10 10 01 00 13 A2 00 42 3E 9A 50 FF FE 00 00 43 53 3C  CD to CMS Alerts "CS"
  0x7E, 0x00, 0x10, 0x10, 0x01,
  0x00, 0x13, 0xA2, 0x00, 0x42, 0x3E, 0x9A, 0x50,
  0xFF, 0xFE, 0x00, 0x00,
  0x43, 0x53,
  0x3C
}; 

uint8_t crusherRestartFrame[] = {  //7E 00 10 10 01 00 13 A2 00 42 3E 9A 50 FF FE 00 00 43 52 3D  CD to CMS Alerts "CR"
  0x7E, 0x00, 0x10, 0x10, 0x01,
  0x00, 0x13, 0xA2, 0x00, 0x42, 0x3E, 0x9A, 0x50,
  0xFF, 0xFE, 0x00, 0x00,
  0x43, 0x52,
...
uint8_t screenStoppedFrame[] = {  //7E 00 10 10 01 00 13 A2 00 42 3E 9A 50 FF FE 00 00 53 53 2C  CD to CMS Alerts "SS"
  0x7E, 0x00, 0x10, 0x10, 0x01,
  0x00, 0x13, 0xA2, 0x00, 0x42, 0x3E, 0x9A, 0x50,
  0xFF, 0xFE, 0x00, 0x00,
  0x53, 0x53,
...
uint8_t screenRestartFrame[] = {  //7E 00 10 10 01 00 13 A2 00 42 3E 9A 50 FF FE 00 00 53 52 2D  CD to CMS Alerts "SR"
  0x7E, 0x00, 0x10, 0x10, 0x01,
  0x00, 0x13, 0xA2, 0x00, 0x42, 0x3E, 0x9A, 0x50,
  0xFF, 0xFE, 0x00, 0x00,
  0x53, 0x52,
